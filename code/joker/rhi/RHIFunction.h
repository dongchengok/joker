...
// extern void RHIInitRenderer(const char* szAppName, const RHIRendererDesc* pSettings, RHIRenderer** ppRenderer);
...
// JDECL_RHI_FUNC(void, RHIUpdateDescriptorSet, RHIRenderer* pRenderer, u32 uIndex, RHIDescriptorSet* pDescriptorSet, u32 uCount,
...
// JDECL_RHI_FUNC(void, RHICmdBindRenderTargets, RHICmd* pCmd, u32 renderTargetCount, RHIRenderTarget** ppRenderTargets, RHIRenderTarget* pDepthStencil,
//                const RHILoadActionsDesc* pLoadActions, u32 pColorArraySlices, u32* pColorMipSlices, u32 uDepthArraySlice, u32 uDepthMipSlice)
// JDECL_RHI_FUNC(void, RHICmdSetShadingRate, RHICmd* pCmd, EShadingRate eShadingRate, RHITexture* pTexture, EShadingRateCombiner ePostRasterizerRate,
...
// JDECL_RHI_FUNC(void, RHICmdBindDescriptorSetWithRootCbvs, RHICmd* pCmd, u32 uIndex, RHIDescriptorSet* pDescriptorSet, u32 uCount,
//                const RHIDescriptorData* pParams)
...
// JDECL_RHI_FUNC(void, RHICmdDrawIndexedInstanced, RHICmd* pCmd, u32 uIndexCount, u32 uFirstIndex, u32 uInstanceCount, u32 uFirstVertex,
//                u32 uFirstInstance)
// JDECL_RHI_FUNC(void, RHICmdDispatch, RHICmd* pCmd, u32 uGroupCountX, u32 uGroupCountY, u32 uGroupCountZ)

// JDECL_RHI_FUNC(void, RHICmdResourceBarrier, RHICmd* pCmd, u32 uBufferBarrierCount, RHIBufferBarrier* pBufferBarriers, u32 uTextureBarrierCount,
...
// JDECL_RHI_FUNC(void, RHIAcquireNextImage, RHIRenderer* pRenderer, RHISwapChain* pSwapChain, RHISemaphore* pSignalSemaphore, RHIFence* pFence,
//                u32 pImageIndex)
...
// JDECL_RHI_FUNC(void, RHIAddIndirectCommandSignature, RHIRenderer* pRender, const RHICommandSignatureDesc* pDesc,
...
// JDECL_RHI_FUNC(void, RHICmdExecuteIndirect, RHICmd* pCmd, RHICommandSignature* pCommandSignature, u32 uMaxCommandCount, RHIBuffer* pIndirectBuffer,
...
// JDECL_RHI_FUNC(u32, RHICmdWriteMarker, RHICmd* pCmd, EMarkerType eMarkerType, u32 uMarkerValue, RHIBuffer* pBuffer, size_t uOffset,
//                bool bUseAutoFlags)
